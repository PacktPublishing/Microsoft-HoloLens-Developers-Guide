...
namespace SpatialDemo
{
    ...
    /// </summary>
    internal class SpatialDemoMain : IDisposable
    {
        ...
        public SpatialDemoMain(DeviceResources deviceResources)
        {
...
// This line is the original, the second is new
referenceFrame = locator.CreateStationaryFrameOfReferenceAtCurrentLocation();
_spatialSurfaceRenderer = new SpatialSurfaceRenderer(deviceResources, referenceFrame.CoordinateSystem);
...
if(_spatialSurfaceRenderer != null)
{
    _spatialSurfaceRenderer.Dispose();
    _spatialSurfaceRenderer = null;
}
#endif
        }
...
_spatialSurfaceRenderer.Update();
        ...
        public void OnDeviceLost(Object sender, EventArgs e)
        {
            ...
            _spatialSurfaceRenderer.ReleaseDeviceDependentResources();
#endif
        ...
        public void OnDeviceRestored(Object sender, EventArgs e)
        {
            ...
            _spatialSurfaceRenderer.CreateDeviceDependentResourcesAsync();
#endif
        }
